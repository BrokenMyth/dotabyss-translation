...
class Manifest:
    CONTENT_TYPES = ("names","m_ability_details","m_buff_types","m_chapter_quests","m_character_action_skills","m_character_profiles","m_dictionary_non_player_characters","m_dictionary_worlds","m_enemy_skills","m_enchantment_details","m_event_top_characters","m_gacha_group_movies","m_missions","m_nether_floor_event_parts","m_nether_floor_events","m_nether_code_category_skills","m_nether_codes","m_novel_character_skins","m_novel_characters","m_novel_events","m_novel_homes","m_novel_mains","m_novel_others","m_novel_prologues","m_part_voices","m_plans","m_preregist_taverns","m_tavern_character_cards","ui_texts")
